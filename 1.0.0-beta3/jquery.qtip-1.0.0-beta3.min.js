...
else function hideMethod(){};if(self.options.show.when.target.add(self.options.show.when.target).length===1&&self.options.show.when.event==self.options.hide.when.event&&self.options.show.when.event=='click')
showTarget.toggle(showMethod,hideMethod);else
{showTarget.bind(self.options.show.when.event+'.qtip',showMethod);hideTarget.bind(self.options.hide.when.event+'.qtip',hideMethod);}}
else
